...
const api_key = 'qmFPcpp4ZnChQdF5';
const vacations = [];

// Screen Loader
let loadingMessages = ['Your results are being calculated...',
...
function appendInterests(vacation, dateIndex, callback) {
  ...
  var api_url =
    ...
    interest.category +
    '&location=' +
    vacation.city.cityName +
    '&date=' +
    vacation.dateWindows[dateIndex].startDate +
    '00-' +
    vacation.dateWindows[dateIndex].endDate +
    '00';
